...
public class BlackTeaItem extends AwaSnackModElements.ModElement {
	@ObjectHolder("awa_snack:black_tea")
	public static final Item block = null;
	public BlackTeaItem(AwaSnackModElements instance) {
		super(instance, 13);
	}
